            ...
            for (int i = 0; ; i++) {
                ...
                switch (instruction & 255) {
                    ...
                    case Opcodes.OP_NEW_ARRAY:
                        ...
                        break;
                    case Opcodes.OP_FILLED_NEW_ARRAY:
                        ins3 = new Format3(instruction, f.readUshort(), f.readUshort());
                        add(ins3);
                    ...
                    case Opcodes.OP_FILL_ARRAY_DATA:
                    ...
                    case Opcodes.OP_GOTO:
                        ...
                        break;
                    case Opcodes.OP_GOTO_16:
                        ins2 = new Format2(instruction, f.readUshort());
                        add(ins2);
                        System.out.println(" goto/16 +"+(short)ins2.CCCC());
                        break;
                    case Opcodes.OP_GOTO_32:
                    ...
                    case Opcodes.OP_XOR_INT_LIT8:
                        ...
                        break;
                    case Opcodes.OP_SHL_INT_LIT8:
                        ins2 = new Format2(instruction, f.readUshort());
                        add(ins2);
                        System.out.println(" shl-int/lit8 v"+ins2.AA()+" v"+ins2.CC()+" #+"+ins2.DD());
                        break;
                    case Opcodes.OP_SHR_INT_LIT8:
                        ins2 = new Format2(instruction, f.readUshort());
                        add(ins2);
                        System.out.println(" shr-int/lit8 v"+ins2.AA()+" v"+ins2.CC()+" #+"+ins2.DD());
                        break;
                    case Opcodes.OP_USHR_INT_LIT8:
                        ins2 = new Format2(instruction, f.readUshort());
                        add(ins2);
                        System.out.println(" ushr-int/lit8 v"+ins2.AA()+" v"+ins2.CC()+" #+"+ins2.DD());
                        break;
                    case Opcodes.OP_IGET_WIDE_VOLATILE:
                    case Opcodes.OP_IPUT_WIDE_VOLATILE:
                    case Opcodes.OP_SGET_WIDE_VOLATILE:
                    case Opcodes.OP_SPUT_WIDE_VOLATILE:
                    case Opcodes.OP_BREAKPOINT:
                    case Opcodes.OP_EXECUTE_INLINE:
                    case Opcodes.OP_EXECUTE_INLINE_RANGE:
                    case Opcodes.OP_INVOKE_DIRECT_EMPTY:
                    ...
                    case Opcodes.OP_INVOKE_VIRTUAL_QUICK_RANGE:
                    case Opcodes.OP_INVOKE_SUPER_QUICK:
                    case Opcodes.OP_INVOKE_SUPER_QUICK_RANGE:
